...
<p class="titulo2"><b>Perfect Body Lucena</b> titular de este sitio web informa que se utilizan cookies y/o tecnologías
...
<p class="titulo2"><b>-Técnicas:</b> Son aquellas necesarias para la navegación y el buen funcionamiento de nuestro
    ...
    <br>
<p class="titulo2"><b>-De análisis:</b> Son aquellas que, tratadas por nosotros o por terceros, nos permiten cuantificar
    el
    ...
    <br>
<p class="titulo2"><b>-Publicitarias:</b> Son aquéllas que permiten la gestión, de la forma más eficaz posible, de los
    espacios
    publicitarios que se pudieran incluir en nuestro website.
    <br>
<p class="titulo2"><b>-Publicitarias comportamentales:</b> Son aquellas que, tratadas por nosotros o por terceros, nos
    permiten
    analizar sus hábitos de navegación en Internet para que podamos mostrarle publicidad relacionada con su perfil de
    navegación.</p>
<h2 class="titulo">3. Identificación De Quién Utiliza Las Cookies.</h2>
<p class="titulo2">La información obtenida por las cookies es tratada solo por nuestro editor y/o también por terceros
    con
...
<p class="titulo2"><b>-Cookies de terceros:</b> Son aquellas que se envían a su equipo desde un equipo o dominio que no
    es
    gestionado por nosotros, sino por otra entidad colaboradora. Como, por ejemplo, las usadas por redes sociales, o por
    contenido externo como Google Maps.
<h2 class="titulo">4. Puede Usted Permitir O Bloquear Las Cookies, Así Como Borrar Sus Datos De Navegación (Incluidas
    Las Cookies)</h2>
<p class="titulo2">Desde el navegador que usted utiliza. Consulte las opciones e instrucciones que ofrece su navegador
...
<h2 class="titulo">6. La Elaboración De Perfiles Que Realizamos Implica La Toma De Decisiones Automatizadas Con Efectos
    Jurídicos Para El Usuario O Que Le Afectan Significativamente De Modo Similar</h2>
<h2 class="titulo">7. Periodo De Conservación De Los Datos Para Los Diferentes Fines En Los Términos Establecidos En El
...
<p class="titulo2"><b>-Cookies persistentes:</b> Son almacenadas en el disco duro y nuestra web las lee cada vez que el
    Usuario
    realiza una nueva visita. Una cookie permanente posee una fecha de expiración determinada. La cookie dejará de
    funcionar después de esa fecha. Estas cookies las utilizamos, generalmente, para facilitar los servicios de compra y
    registro.
...
<p class="titulo2">Puede permitir, bloquear o eliminar las cookies instaladas en su equipo mediante la configuración de
...
<p class="titulo2">Ni esta web ni sus representantes legales se hacen responsables ni del contenido ni de la veracidad
    de
    las políticas de privacidad que puedan tener los terceros mencionados en la Aviso Legal.
    Los navegadores web son las herramientas encargadas de almacenar las cookies y desde este lugar debes efectuar tu
    derecho a eliminación o desactivación de las mismas.
    Ni esta web ni sus representantes legales pueden garantizar la correcta o incorrecta manipulación de las cookies por
    parte de los mencionados navegadores. En algunos casos es necesario instalar cookies para que el navegador no olvide
    tu decisión de no aceptación de las mismas.
    En el caso de las cookies de Google Analytics, esta empresa almacena las cookies en servidores ubicados en Estados
    Unidos y se compromete a no compartirla con terceros, excepto en los casos en los que sea necesario para el
    funcionamiento del sistema o cuando la ley obligue a tal efecto. Según Google no guarda tu dirección IP. Google Inc.
    es una compañía adherida al Acuerdo de Puerto Seguro que garantiza que todos los datos transferidos serán tratados
