        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100 w-100 ">
                    <form method="POST" action="{{ route('instalaciones.update', ['instalacione' => $clase->id]) }}"
                        ...
                        <div class="mb-6">
                            <label for="text"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Descipcion Corta</label>
                            <input type="text" name="descripcion_corta" id="descripcion_corta"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                value="{{ $clase->descripcion_corta }}" required>
                        </div>
                        <div class="mb-6">
                            <label for="imagen"
